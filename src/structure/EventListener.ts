...
export const createEventListenerFactory =
    <EventName extends keyof ClientEvents>(eventName: EventName) => (listener: EventListenerFn<EventName>) => new EventListener(eventName, listener);

export class EventListener<EventName extends keyof ClientEvents> {
    // eslint-disable-next-line no-useless-constructor, no-empty-function
    public constructor(public readonly eventName: EventName, public readonly listener: EventListenerFn<EventName>) {}
}
